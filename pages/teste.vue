    ...
    <div>
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="inline-flex mt-2 xs:mt-0 gap-2">
              ...
              <button @click="next()" class="px-4 py-2 text-sm font-medium text-white bg-goias-50 rounded-r hover:bg-goias-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                  Próximo
              </button>
          </div>
        </div>
...
function next(){
  ...
  // servidores.value = await fetchArticles();
...
//   const getTotalServidores = async () => {
//     try {
...
//   const qtdServidores = await getTotalServidores();
